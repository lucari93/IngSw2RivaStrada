...
\item[Astah Professional:] We used this desktop application to create all the others UML Diagrams.
...
We spent the following amount of hours for redacting this document:
\begin{description}
\item[Riva Luca:]
\item[Strada Jacopo:]
\end{description}
