...
\todo{Che cazzo sono?????????? chiedi al customer}
...
\hline
    ...
    \cline{2-3} & \textbf{R5} & \todo[inline]{todo}\\
    
    \hline
    \hline
    
    \multirow{6}*{\textbf{G1}} & \textbf{R1} & \multirow{3}{\customTableWidth}{Validation made by the \textit{account manager}}\\
    \cline{2-2} & \textbf{R2}&\\
    \cline{2-2} & \textbf{R3}&\\
    ...
    \cline{2-3} & \textbf{R6} & \todo[inline]{todo}\\
